...
kotlin {
    ...
    val xcf = XCFramework("UnicodeIdent")

    macosArm64 {
        binaries.framework { baseName = "UnicodeIdent"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "UnicodeIdent"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "UnicodeIdent"
        flattenPackage = "io.github.kotlinmania.unicodeident"
    }

    android {
        namespace = "io.github.kotlinmania.unicodeident"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "unicode-ident-kotlin", version.toString())

    pom {
        name.set("unicode-ident-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/unicode-ident - XID_Start and XID_Continue lookups for Unicode Standard Annex #31 identifier characters")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/unicode-ident-kotlin")
        ...
        licenses {
            ...
            license {
                ...
                url.set("https://www.unicode.org/license.txt")
                distribution.set("repo")
            }
        }
        ...
        scm {
            url.set("https://github.com/KotlinMania/unicode-ident-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/unicode-ident-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/unicode-ident-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/unicodeident/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.unicodeident.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleUnicodeIdentXCFramework",
    "assembleUnicodeIdentDebugXCFramework",
    "assembleUnicodeIdentReleaseXCFramework",
    "assembleDebugIosFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseIosFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugMacosFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseMacosFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugTvosFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseTvosFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugWatchosFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseWatchosFatFrameworkForUnicodeIdentXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForUnicodeIdentXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForUnicodeIdentXCFramework",
